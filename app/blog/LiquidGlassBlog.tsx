...
const themeToOption = { dark: "1", dim: "2" } as const;
...
export default function LiquidGlassBlog() {
  ...
  return (
    <div className={wrapperClass}>
      {/* Hidden SVG filters for the glass effect */}
      <div className={styles.filterContainer}>
        <svg width="0" height="0" style={{ position: "absolute" }}>
          <filter id="blog-switcher" primitiveUnits="objectBoundingBox">
            <feImage
              result="map"
              width="100%"
              height="100%"
          ...
          <filter id="blog-toggler" primitiveUnits="objectBoundingBox">
            <feImage
              result="map"
              width="100%"
              height="100%"
      ...
      <fieldset
        ...
        data-previous={prevOption}
      >
        <legend className={styles.switcherLegend}>Choose theme</legend>

        {/* Dark */}
        <label className={styles.switcherOption}>
          <input
        ...
        <div style={{
          ...
          <ScrambleText
            ...
            style={{
              ...
              textAlign: "center",
              color: "#ffffff",
              textShadow: "0 0 18px rgba(0,234,255,0.6), 0 0 40px rgba(189,0,255,0.4), 0 0 80px rgba(255,0,255,0.15)",
            }}
          />
          <ScrambleText
            text="Assine :"
                ...
                <div style={{ display: "flex", flexDirection: "column", flex: 1, gap: 4 }}>
                  <div style={{ display: "flex", gap: 8 }}>
                    <input
                      ...
                      onFocus={e => !emailError && (e.currentTarget.style.borderColor = "rgba(255,255,255,0.5)")}
                      onBlur={e => {
                        const err = validateEmail(email);
                        setEmailError(err);
                        if (!err) e.currentTarget.style.borderColor = "rgba(255,255,255,0.2)";
                      }}
                    />
                    <button
                      type="button"
          ...
          <img
            ...
            style={{
              ...
              objectFit: "contain",
              borderRadius: 0,
              animation: "astronaut-float 4s ease-in-out infinite, astronaut-color 3s ease-in-out infinite",
            }}
          />
        </div>
      </article>
