...
export const translations = {
  pt: {
    ...
    skills: {
      ...
      principlesHint: "ver →",
      sectionSpecialties: "especializações",
      sectionPrinciples: "princípios de engenharia",
      sectionStack: "stack completa",
      ...
      softSkillsParagraph: [
        { label: "Resolução de problemas", rest: " com foco em tradeoffs reais — " },
        { label: "comunicação clara", rest: " com times técnicos e não-técnicos — " },
        { label: "aprendizado contínuo", rest: " aplicado diretamente em projetos — " },
        { label: "atenção a detalhes", rest: " tanto em código quanto em UX — " },
        { label: "adaptabilidade", rest: " em contextos ágeis com requisitos em mudança." },
      ],
  ...
  en: {
    ...
    skills: {
      ...
      sectionPrinciples: "engineering principles",
      ...
      specialties: [
        {
          badge: "4+ years",
          title: "Frontend & UI Performance",
          desc: "SPAs, SSR/SSG, design systems and Web Vitals in production.",
          tags: ["React", "Next.js", "TypeScript", "Tailwind", "Web Vitals"],
        },
        {
          badge: "3+ years",
          title: "Backend & APIs",
          desc: "REST APIs, MVC architecture, authentication and integrations.",
          tags: ["PHP", "Laravel", "Node.js", "Express", "JWT/Auth"],
        },
        {
          badge: "2+ years",
          title: "Databases",
          desc: "Relational modeling, optimized queries and migrations.",
          tags: ["PostgreSQL", "MySQL", "Eloquent", "SQL tuning"],
        },
        {
          badge: "evolving",
          title: "DevOps & Tooling",
          desc: "Containerization, CI/CD, versioning and automation.",
          tags: ["Docker", "Git", "GitHub Actions", "pnpm"],
        },
      ],
      principles: [
        "Components with single responsibility and explicit interfaces",
        "Performance as a requirement, not late optimization",
        ...
        "Document architecture decisions, not the obvious",
      ],
      softSkillsParagraph: [
        { label: "Problem solving", rest: " focused on real tradeoffs — " },
        { label: "clear communication", rest: " with technical and non-technical teams — " },
        { label: "continuous learning", rest: " applied directly to projects — " },
        { label: "attention to detail", rest: " in both code and UX — " },
        { label: "adaptability", rest: " in agile contexts with changing requirements." },
      ],
